...
Simply run [Oneclick](https://github.com/QuakedK/Oneclick/releases/download/Tweak/Oneclick-V5.3.bat) as admin, and almost everything else is automatic, except user-required inputs.
