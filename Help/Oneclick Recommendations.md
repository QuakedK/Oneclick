...
Priority Separation | 36 Decimal - 24 Hexadecimal Recommended, more info here -> [Priority Separation Options](https://github.com/QuakedK/Oneclick/blob/main/Help/Priority%20Separation%20Options.md).

Timer Resolution Value | 5040ms or skipping it is recommended, more info here -> [Timer Resolution Options](https://github.com/QuakedK/Oneclick/blob/main/Help/Timer%20Resolution%20Options.md).
...
Process Destroyer | Not Recommended, more info here -> [Requirements](https://github.com/QuakedK/Process-Destroyer/tree/main#requirements) & [Unsupported Features List](https://github.com/QuakedK/Process-Destroyer/blob/main/Unsupported%20Features.md).

Network Tweaks | Not Recommended, more info here -> [Network Tweaks](https://github.com/QuakedK/Oneclick/blob/main/Help/Network%20Tweaks.md).

Optional Features | Not Recommended, more info here -> [Optional Features](https://github.com/QuakedK/Oneclick/blob/main/Help/Optional%20Features.md).

Device Manager Tweaks | Not Recommended, more info here -> [Device Manager Tweaks](https://github.com/QuakedK/Oneclick/blob/main/Help/Device%20Manager%20Tweaks.md).
